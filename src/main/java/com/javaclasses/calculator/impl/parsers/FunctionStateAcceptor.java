...
/**
 * Implementation of the StateAcceptor interface for Function StateAcceptor
 */
public class FunctionStateAcceptor implements StateAcceptor {

    private final Logger log = LoggerFactory.getLogger(FunctionStateAcceptor.class);
